...
useEffect(() => {
  ...
  return (
    <div className={cx("wrapper")}>
      <span className={cx("title")}>Descubrí las detecciones con IA</span>
      <span className={cx("content")}>
        Explorá el listado de anuncios detectados por la inteligencia artificial
        sobre el <b>marketing digital de sucedáneos de la leche humana.</b>{" "}
        Nuestros expertos identificarán las detecciones confirmadas, mientras
        que las demás estarán pendientes de revisión.
        <br />
        <br />
        <b>Navegá por la tabla</b> hacia la derecha para ver todas las columnas
        y usá los filtros para realizar búsquedas específicas.
      </span>
      ...
      <div className={cx("table-container")}>
        ...
        <div className={cx("col-right")}>
          <div className={cx("headers")}>
            <div className={cx("scroller", "syncscroll ", "scroll_same_time")} ref={headersRef}>
