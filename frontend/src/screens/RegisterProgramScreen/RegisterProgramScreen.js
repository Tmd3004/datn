        ...
        <div className={cx("tab-content")}>
          {navActive === "link0" ? (
                    ...
                    <div className="col-sm-8" style={{ marginLeft: "20px" }}>
                      <label className={cx("control-label")}>
                        <input
                          ...
                          checked={dataInfor?.topicType === "Lý thuyết"}
                          value="Lý thuyết"
                      ...
                      <label className={cx("control-label")}>
                        <input
                          ...
                          name="category"
                          onChange={(e) => setTopicType(e.target.value)}
                          checked={dataInfor?.topicType === "Thực nghiệm"}
                          value="Thực nghiệm"
                          style={{ marginRight: "6px" }}
                        />
                        Thực nghiệm
                      ...
                      <label className={cx("control-label")}>
                        <input
                          ...
                          name="category"
                          onChange={(e) => setTopicType(e.target.value)}
                          checked={dataInfor?.topicType === "Đề tài mới"}
                          value="Đề tài mới"
                          style={{ marginRight: "6px" }}
                        />
                        Đề tài mới
                      ...
                      <label className={cx("control-label")}>
                        <input
                          ...
                          name="category"
                          onChange={(e) => setTopicType(e.target.value)}
                          checked={dataInfor?.topicType === "Đề tài tiếp theo"}
            ...
            <>
              <div className={cx("tab-box")} style={{ marginBottom: "20px" }}>
                <div className={cx("panel-heading")}>
                  <b style={{ paddingRight: "8px" }}>A. Tình trạng hồ sơ</b>
                </div>
              ...
              {status === "propose" ? (
                <div className={cx("tab-box")}>
                  <div className={cx("panel-heading")}>
                    <b style={{ paddingRight: "8px" }}>B. Nộp hồ sơ</b>
                  </div>
              ...
              {status !== "propose" && userInfo.isAdmin ? (
                <div className={cx("tab-box")}>
                  <div className={cx("panel-heading")}>
                    <b style={{ paddingRight: "8px" }}>B. Xác nhận hồ sơ</b>
                  </div>
